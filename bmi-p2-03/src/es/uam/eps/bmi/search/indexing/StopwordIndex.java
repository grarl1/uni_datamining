...
/**
 * Stopword index class. Filters stopwords preventing them from getting being
 * indexed.
 *
...
public class StopwordIndex extends BasicIndex {
    ...
    /**
     * Main class for Stopword index.
     *
     * It indexes a set of documents, creating an index in the output directory.
     * Parses the content of each file removing stopwords.
     *
    ...
    public static void main(String[] args) {
        ...
        // Build the index
        StopwordIndex stopwordIndex = new StopwordIndex();
        stopwordIndex.build(args[0], args[1], new StopwordParser());
